...
extern uint64 sys_chmod(void);// added chmod
extern uint64 sys_chown(void);// added chown
...
[SYS_chmod]	sys_chmod, // added for chmod
[SYS_chown]	sys_chown, // added for chown
